# Generated by Django 3.1.14 on 2022-11-29 23:46
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('pokemon_entities', '0013_auto_20221129_2239'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='pokemon',
            name='title',
            field=models.TextField(max_length=200, verbose_name='Навзание на русском'),
        ),
        migrations.AlterField(
            model_name='pokemon',
            name='title_eng',
            field=models.TextField(blank=True, max_length=30, verbose_name='Название на английском'),
        ),
        migrations.AlterField(
            model_name='pokemon',
            name='title_jp',
            field=models.TextField(blank=True, max_length=30, verbose_name='Название на японском'),
        ),
        migrations.AlterField(
